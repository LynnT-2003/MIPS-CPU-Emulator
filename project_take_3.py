        ...
        while self.pc < len(program):
            ...
            if opcode == "mov":
                ...
                if isinstance(src_reg_or_value, int):
                    ...
                    src_reg_or_value_binary = format(src_reg_or_value, '016b')
                    # Encoding for "mov" instruction with immediate value
                    encoded_instruction = "0000{:03}{}".format(
                        dest_reg, src_reg_or_value_binary)
                else:
                    src_reg = self.register_mapping[src_reg_or_value]
                    # Encoding for "mov" instruction with source register
